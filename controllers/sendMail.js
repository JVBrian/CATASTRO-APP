...
const sendEmail = (to, url, txt) => {
    ...
    const mailOptions = {
        ...
        to: to,
        subject: "CATASTRO APP",
        html: `
            <div style="max-width: 700px; margin:auto; border: 10px solid #ddd; padding: 50px 20px; font-size: 110%;">
            <h2 style="text-align: center; text-transform: uppercase;color: teal;">Bienvenido(a) a la aplicación Catastral</h2>
            <p>Felicidades, ya puedes iniciar sesión en CATASTRO✮.
