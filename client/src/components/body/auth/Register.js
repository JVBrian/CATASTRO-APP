...
import {isEmpty, isEmail, isLength, isMatch, isLengthCed, isCedula} from '../../utils/validation/Validation'
...
function Register() {
    ...
    const handleSubmit = async e => {
        ...
        if(isEmpty(name) || isEmpty(password))
            return setUser({...user, err: "Por favor, rellena todos los campos.", success: ''})
        ...
        if(isLengthCed(cedula))
            return setUser({...user, err: "La cedula  debe tener 10 digitos.", success: ''})
        
        if(!isMatch(password, cf_password))
            return setUser({...user, err: "Las contraseñas son diferentes.", success: ''})
        ...
        <div className="login_page">
            ...
            <br></br>
                ...
                <div>
                    ...
                    <input type="text" placeholder="Ingresa tu cedula" id="cedula"
                    value={cedula} name="cedula" onChange={handleChangeInput}  />
                </div>
                ...
                <div>
                    ...
                    <input type="password" placeholder="Confirma tu contraseña" id="cf_password"
